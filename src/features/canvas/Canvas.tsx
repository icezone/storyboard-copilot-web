...
export function Canvas() {
  ...
  useEffect(() => {
    ...
    if (project) {
      setCanvasData(project.nodes as Parameters<typeof setCanvasData>[0], project.edges as Parameters<typeof setCanvasData>[1], project.history as Parameters<typeof setCanvasData>[2]);
